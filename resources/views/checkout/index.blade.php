...
<main class="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg">
    ...
    <div class="mb-stack-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-stack-md border-2 border-on-surface p-stack-md bg-surface-variant shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        <div class="flex items-center gap-stack-sm opacity-50">
            ...
            <span class="font-label-md text-label-md uppercase">Tickets</span>
        </div>
        ...
        <div class="flex items-center gap-stack-sm">
            ...
            <span class="font-label-md text-label-md uppercase">Payment</span>
        </div>
        <div class="hidden md:block h-0.5 flex-grow bg-on-surface mx-4"></div>
        <div class="flex items-center gap-stack-sm opacity-50">
            ...
            <span class="font-label-md text-label-md uppercase">Summary</span>
        </div>
    </div>
        ...
        <div class="lg:col-span-8 space-y-stack-lg">
            ...
            <section class="bg-surface border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                <div class="bg-secondary text-on-secondary p-stack-md border-b-2 border-on-surface">
                    <h2 class="font-headline-md text-headline-md uppercase">Checkout &amp; Payment</h2>
                </div>
                
                <div class="p-stack-md grid grid-cols-1 md:grid-cols-2 gap-stack-md">
                    <!-- Contact Info -->
                    <div class="md:col-span-2">
                        <label class="font-label-md text-label-md uppercase mb-2 block">Full Name</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="font-label-md text-label-md uppercase mb-2 block">Email Address</label>
                    ...
                    <div class="md:col-span-2 pt-stack-sm">
                        <label class="font-label-md text-label-md uppercase mb-2 block">Payment Method</label>
                        <div class="grid grid-cols-3 gap-stack-sm">
                            <button class="border-2 border-on-surface p-stack-sm flex flex-col items-center justify-center bg-primary-fixed shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none transition-all" type="button">
                                ...
                                <span class="font-label-sm text-label-sm uppercase">Card</span>
                            </button>
                            <button class="border-2 border-on-surface p-stack-sm flex flex-col items-center justify-center bg-surface hover:bg-surface-container-high transition-all" type="button">
                                ...
                                <span class="font-label-sm text-label-sm uppercase">Wallet</span>
                            </button>
                            <button class="border-2 border-on-surface p-stack-sm flex flex-col items-center justify-center bg-surface hover:bg-surface-container-high transition-all" type="button">
                    ...
                    <!-- Card Details -->
                    <div class="md:col-span-2">
                        <label class="font-label-md text-label-md uppercase mb-2 block">Card Number</label>
                        <div class="relative">
                    ...
                    <div>
                        <label class="font-label-md text-label-md uppercase mb-2 block">Expiry Date</label>
        ...
        <aside class="lg:col-span-4">
            <div class="sticky top-24 space-y-stack-md">
                ...
                <div class="bg-surface border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                    <img class="w-full h-48 object-cover border-b-2 border-on-surface" src="{{ $event->image ? asset('storage/' . $event->image) : 'https://placehold.co/600x400/56642b/ffffff?text=Event' }}" alt="{{ $event->title }}"/>
                ...
                <div class="bg-surface border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    <div class="p-stack-md border-b-2 border-on-surface">
                        <h2 class="font-headline-md text-headline-md uppercase">Order Summary</h2>
                    </div>
                    <div class="p-stack-md space-y-stack-sm">
                        <div class="flex justify-between items-center">
                            <span class="text-on-surface-variant">1x Ticket</span>
                            <span class="font-label-md text-label-md">${{ number_format($event->price, 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-on-surface-variant">Booking Fee</span>
                            <span class="font-label-md text-label-md">${{ number_format($bookingFee, 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-on-surface-variant">Processing Tax</span>
                            <span class="font-label-md text-label-md">${{ number_format($tax, 2) }}</span>
                        </div>
                        <div class="pt-stack-md mt-stack-md border-t-2 border-dashed border-on-surface">
                            <div class="flex justify-between items-end">
                                ...
                                <span class="font-display-lg text-headline-md text-primary">${{ number_format($total, 2) }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative bg-tertiary-fixed border-2 border-on-surface p-stack-md shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                    ...
                    <div class="flex items-center gap-stack-md">
                        ...
                        <div>
                            <p class="font-label-md text-label-md uppercase">Instant Delivery</p>
                            <p class="text-body-md text-sm">Tickets sent to your phone immediately after confirmation.</p>
                        </div>
                    </div>
                </div>
