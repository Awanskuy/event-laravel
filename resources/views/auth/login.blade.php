...
<main class="flex-grow flex items-center justify-center p-margin-mobile md:p-margin-desktop relative overflow-hidden">
    ...
    <div class="w-full max-w-[480px] bg-background border-2 border-on-surface shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col">
        ...
        <div class="p-stack-lg border-b-2 border-on-surface bg-primary-container">
            <h1 class="font-headline-md text-headline-md text-on-primary-container">Selamat Datang Kembali</h1>
            <p class="font-body-md text-body-md text-on-primary-container opacity-80 mt-1">Akses tiket dan event-mu.</p>
        </div>
        ...
        <form class="p-stack-lg flex flex-col gap-stack-md" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex flex-col gap-unit">
                <label class="font-label-md text-label-md uppercase tracking-wider text-on-surface" for="email">Alamat Email</label>
            ...
            <div class="flex flex-col gap-unit">
                <div class="flex justify-between items-end">
                    <label class="font-label-md text-label-md uppercase tracking-wider text-on-surface" for="password">Kata Sandi</label>
                    <a class="font-label-sm text-label-sm text-on-surface-variant hover:text-primary underline mb-1" href="#">Lupa Kata Sandi?</a>
                </div>
                <div class="relative group">
            ...
            <div class="flex items-center gap-2 mt-2">
                ...
                <label class="font-body-md text-body-md cursor-pointer select-none" for="remember">Tetap masuk selama 30 hari</label>
            </div>
            ...
            <div class="flex items-center gap-stack-sm my-stack-sm">
                ...
                <span class="font-label-sm text-label-sm text-on-surface-variant">ATAU LANJUT DENGAN</span>
                <div class="h-[2px] flex-grow bg-on-surface opacity-10"></div>
            </div>
        ...
        <div class="p-stack-md border-t-2 border-on-surface bg-surface-container-low text-center">
            <p class="font-body-md text-body-md">
                Baru di KARCIS?
                <a class="font-label-md text-label-md text-secondary underline hover:text-on-secondary-container transition-colors" href="{{ route('register') }}">Buat Akun</a>
            </p>
        </div>
    </div>
    ...
    <div class="hidden lg:block absolute left-[15%] top-[20%] -rotate-6 w-[200px] bg-secondary-container border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-stack-sm -z-10">
        ...
        <span class="font-label-sm text-label-sm text-on-secondary-container font-bold uppercase">Selanjutnya: Techno Night</span>
    </div>
